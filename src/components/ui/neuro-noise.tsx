...
// ("Neuro Noise"). Zero dependencies: one WebGL canvas that fills its
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // control-flow narrowing carries the early `if (!canvas) return` /
    // `if (!gl) return` guards above into this closure.
